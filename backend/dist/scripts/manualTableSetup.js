...
async function createTablesManually() {
    ...
    try {
        ...
        const response = await fetch(`${env_1.config.supabase.url}/rest/v1/rpc/exec`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${env_1.config.supabase.serviceRoleKey}`,
                'apikey': env_1.config.supabase.serviceRoleKey
            },
            body: JSON.stringify({
                sql: `
          -- Create users table
...
//# sourceMappingURL=manualTableSetup.js.map