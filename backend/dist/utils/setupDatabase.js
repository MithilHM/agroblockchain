...
exports.setupDatabaseTables = setupDatabaseTables;
const supabase_1 = require("../config/supabase");
const logger_1 = require("./logger");
async function setupDatabaseTables() {
    try {
        logger_1.logger.info('🔧 Setting up database tables...');
        // Create users table
        await supabase_1.supabaseAdmin.rpc('exec_sql', {
            sql: `
      ...
      `
        ...
        logger_1.logger.info('✅ Database tables setup completed');
    }
    catch (error) {
        logger_1.logger.warn('⚠️  Database tables may need to be created manually in Supabase dashboard');
